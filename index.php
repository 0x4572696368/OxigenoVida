            ...
            <div class="row no-gutters">
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Informacion de los centro de atencion Clinical y Hospitales cercanos a tu ubicación.</p>
                        <a href="#" class="boxed-btn3-white">Acceso libre</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <h3>Botiquin Emergencia</h3>
                        <p>Te recomendamos crear tu botiquin de emergencia .</p>
                        <a href="#" class="boxed-btn3-white">Ingresa</a>
                    </div>
                </div>
            </div>
        </div>
